...
namespace TreeViewWithViewModelDemo.LoadOnDemand
{
        ...
        /// </summary>
        public static class UIEventToCommand
        {
            /// <summary>
            /// 事件名称
            /// </summary>
            public static readonly DependencyProperty EventProperty = DependencyProperty.RegisterAttached("Event", typeof(string), typeof(UIEventToCommand), new PropertyMetadata(OnEventChanged));
            /// <summary>
            /// 操作属性
            /// </summary>
            public static readonly DependencyProperty CommandProperty = DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(UIEventToCommand), new PropertyMetadata(null));
            /// <summary>
            /// 获取事件名称属性
            /// </summary>
